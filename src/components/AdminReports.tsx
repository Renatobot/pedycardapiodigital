      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400">
            Análise detalhada do desempenho da plataforma • {format(new Date(), "MMMM 'de' yyyy", { locale: ptBR })}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-emerald-900/50 to-emerald-800/30 border-emerald-700/50">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-emerald-300/80">Receita Mensal (MRR)</p>
                <p className="text-2xl font-bold text-emerald-400">
                  {formatCurrency(metrics.estimatedMRR)}
                </p>
                <p className="text-xs text-slate-400 mt-1">
                  {metrics.actives} planos ativos
                </p>
              </div>
        ...
        <Card className="bg-gradient-to-br from-purple-900/50 to-purple-800/30 border-purple-700/50">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-purple-300/80">Upgrade Pro+</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">
                  {metrics.expired} estabelecimentos
                </p>
              </div>
      ...
      <Card className="bg-slate-800 border-slate-700">
        <CardHeader>
          ...
          <CardDescription className="text-slate-400">
            Análise detalhada do funil de conversão de trials
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="text-center p-4 bg-slate-700/50 rounded-lg relative">
              ...
              <p className="text-sm text-slate-400 mt-1">Em Trial Agora</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="bg-slate-700/50 border-slate-600">
              <CardContent className="p-4">
                ...
                <p className="text-xs text-slate-500 mt-2">
                  Meta: 30% • {metrics.conversionRate >= 30 ? '✓ Atingida' : `Faltam ${(30 - metrics.conversionRate).toFixed(1)}%`}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-700/50 border-slate-600">
              <CardContent className="p-4">
                ...
                />
                <p className="text-xs text-slate-500 mt-2">
                  {metrics.retainedOver30Days} ativos há +30 dias
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-amber-200 font-medium">
                    {metrics.expiringTrials} trial{metrics.expiringTrials > 1 ? 's' : ''} expirando em até 3 dias
                  </p>
                  <p className="text-sm text-amber-300/70">
                    Considere entrar em contato para incentivar a conversão
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500">({metrics.planDistribution.trial.percentage.toFixed(1)}%)</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500">({metrics.planDistribution.active.percentage.toFixed(1)}%)</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500">({metrics.planDistribution.proPlus.percentage.toFixed(1)}%)</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500">({metrics.planDistribution.expired.percentage.toFixed(1)}%)</span>
                </div>
              </div>
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Principais indicadores do período</p>
            </div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Pro+ Ativos</p>
            </div>
            <div>
